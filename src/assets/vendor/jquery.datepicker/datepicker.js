	...
	var DatePicker = function () {
		var	ids = {},
			...
			defaults = {
				...
				locale: {
					days: ["Воскресенье", "Понедельник", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"],
					daysShort: ["ВС", "ПН", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"],
			...
			fill = function(el) {
				...
				for (var i = 0; i < options.calendars; i++) {
					...
					while (cnt < 42) {
						...
						// var nowDate = date.setDate(date.getDate()+2);
						...
						// if (date == val) {
						// 	data.weeks[indic].days[indic2].classname.push('datepickerSEVEN');
						// }
						...
						if (val >= options.date[0] && val <= options.date[1]) {
							data.weeks[indic].days[indic2].classname.push('datepickerSelected2');
						}
