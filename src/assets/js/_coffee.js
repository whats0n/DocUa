...
$(function() {
  var a, c, d, e, f, g, h, i, l, m, n, o, p, r, s, t, u;
  t = void 0;
  e = void 0;
  n = void 0;
  i = void 0;
  ...
  t.length > 0 && $('.body-map__container').length > 0 && (e = t.find('[data-zone-id=\'common\']'));
    ...
    return n = function(e) {
      ...
      while (d > c) {
        ...
        i.mouseover(function() {
          ...
          return t.trigger('mouseoverZone', {
            gender: r,
            side: h,
            detailed: o,
            zoneId: e.id
        ...
        i.mouseup(function(i) {
          ...
          if (n) {
            ...
            a = s.offset();
            l = i.offsetX || i.pageX - a.left;
            c = i.offsetY || i.pageY - a.top;
            t.trigger('clickZone', {
              gender: r,
              side: h,
              detailed: o,
...
t.find('.body-map__select [name=\'gender\']').change(function() {
  d();
  return t.trigger('selectGender', {
    gender: r
  });
});

t.find('.body-map__rotate').click(function() {
  f();
  return t.trigger('selectSide', {
    side: h
  });
});

t.find('.body-map__zoom').click(function() {
  p();
  return t.trigger('selectDetailed', {
    detailed: o
  });
});

t.on('selectZone', function(t, e) {
  return c(e.zoneId);
});
...
a = function(e) {
  ...
  t.on('clickZone', function(e, n) {
    ...
    o = void 0;
    r = void 0;
    if ('common' === (r = n.zoneId) || 'skin' === r || n.detailed) {
      t.trigger('selectZone', {
        zoneId: n.zoneId
      });
    } else {
      p();
    ...
    i = o.parent();
    return t.find('.body-map__main').css({
